...
export function Hero() {
  return (
    <section className="relative overflow-hidden min-h-[55vh] lg:min-h-[65vh] flex items-center pt-16 pb-16 lg:py-0">
      ...
      {/* Conteúdo */}
      <div className="relative z-20 mx-auto max-w-7xl px-6 lg:px-10 w-full">
        <motion.div
